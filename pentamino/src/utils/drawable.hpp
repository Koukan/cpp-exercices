...
public:
    ...
    , data_([this]{
        ...
        if (sz == 0) {
            throw ERR_RECORDER_EMPTY_IMAGE;
        }
        ...
        if (nullptr == data) {
            throw ERR_RECORDER_FRAME_ALLOCATION_FAILED;
        }
        return data;
    }())
    {}
...
public:
    void mem_blt_ex( Rect rect
        ...
        switch (rop) {
            ...
            default:
                LOG2(LOG_INFO, "Drawable::mem_blt_ex(): unimplemented rop=%X", rop);
                break;
        }
    }
    ...
    void mem_3_blt( Rect rect
        ...
        switch (rop) {
            ...
            default:
                LOG2(LOG_INFO, "Drawable::mem_3_blt(): unimplemented rop=%X", rop);
            break;
        }
    }
...
public:
        ...
        const uint8_t * brush_data, int8_t org_x, int8_t org_y)
    {
        ...
        default:
            // should not happen
            LOG1(LOG_INFO, "Unsupported parameters for PatBlt Primary Drawing Order!");
